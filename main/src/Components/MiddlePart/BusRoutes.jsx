...
const BusDestination = () => {
  var destination_array = [
...

    {
      ...
      para:
        'Your search for the best and cheapest deals on top searched routes in India ends here. Choose from sleeper, semi-sleeper, volvo and many more buses while booking online and get the cheapest fare, multiple paying options, best discounts and 24x7 customer service.',
